package com.jrm.adolp.animationcustomviewset.view;
...
public class TheThreeDBox extends ViewGroup {
    ...
    public TheThreeDBox(Context context) {
        this(context,null);
    }

    public TheThreeDBox(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TheThreeDBox(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY){
            width = measureWidth;
            childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(width - (params.leftMargin + params.rightMargin) , MeasureSpec.EXACTLY);
        }

        if (heightMode == MeasureSpec.EXACTLY){
            height = measureHeight;
            childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(height - (params.topMargin + params.bottomMargin) , MeasureSpec.EXACTLY);
        }
    ...
    @Override
    protected void onLayout(boolean b, int left, int i1, int i2, int i3) {
        MarginLayoutParams params = (MarginLayoutParams) this.getLayoutParams();
        int childTop = 0;
